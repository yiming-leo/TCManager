...
public class GetShipInfoExcel {
     ...
     */
    @PostMapping("/shipinfo_excel")
    public ResponseEntity getShipInfoExcel() throws IOException {

        //生成文件到自己服务器
        shipInfoService.getShipInfoExcel();

        FileSystemResource file = new FileSystemResource(shipInfoLocation);
